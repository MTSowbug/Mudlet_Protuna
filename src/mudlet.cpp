...
QString mudlet::getMudletPath(const mudletPathType mode, const QString& extra1, const QString& extra2)
{
    ...
    case mainPath:
        ...
        return qsl("%1/.config/mudletuna").arg(QDir::homePath());
    case mainDataItemPath:
        ...
        // argument does:
        return qsl("%1/.config/mudletuna/%2").arg(QDir::homePath(), extra1);
    case mainFontsPath:
        // (Added for 3.5.0) a revised location to store Mudlet provided fonts
        return qsl("%1/.config/mudletuna/fonts").arg(QDir::homePath());
    case profilesPath:
        // The directory containing all the saved user's profiles - does not end
        // in '/'
        return qsl("%1/.config/mudletuna/profiles").arg(QDir::homePath());
    case profileHomePath:
        ...
        return qsl("%1/.config/mudletuna/profiles/%2").arg(QDir::homePath(), extra1);
    case profileMediaPath:
        ...
        return qsl("%1/.config/mudletuna/profiles/%2/media").arg(QDir::homePath(), extra1);
    case profileMediaPathFileName:
        ...
        return qsl("%1/.config/mudletuna/profiles/%2/media/%3").arg(QDir::homePath(), extra1, extra2);
    case profileXmlFilesPath:
        // Takes one extra argument (profile name) that returns the directory
        // for the profile game save XML files - ends in a '/'
        return qsl("%1/.config/mudletuna/profiles/%2/current/").arg(QDir::homePath(), extra1);
    case profileMapsPath:
        // Takes one extra argument (profile name) that returns the directory
        // for the profile game save maps files - does NOT end in a '/'
        return qsl("%1/.config/mudletuna/profiles/%2/map").arg(QDir::homePath(), extra1);
    case profileDateTimeStampedMapPathFileName:
        ...
        return qsl("%1/.config/mudletuna/profiles/%2/map/%3map.dat").arg(QDir::homePath(), extra1, extra2);
    case profileDateTimeStampedJsonMapPathFileName:
        // Takes two extra arguments (profile name, dataTime stamp) that returns
        // the pathFile name for a dateTime stamped JSON map file:
        return qsl("%1/.config/mudletuna/profiles/%2/map/%3map.json").arg(QDir::homePath(), extra1, extra2);
    case profileMapPathFileName:
        ...
        return qsl("%1/.config/mudletuna/profiles/%2/map/%3").arg(QDir::homePath(), extra1, extra2);
    case profileXmlMapPathFileName:
        ...
        return qsl("%1/.config/mudletuna/profiles/%2/map.xml").arg(QDir::homePath(), extra1);
    case profileDataItemPath:
        ...
        // SlySven):
        return qsl("%1/.config/mudletuna/profiles/%2/%3").arg(QDir::homePath(), extra1, extra2);
    ...
    case profilePackagePathFileName:
        ...
        return qsl("%1/.config/mudletuna/profiles/%2/%3/%3.xml").arg(QDir::homePath(), extra1, extra2);
    case profileReplayAndLogFilesPath:
        ...
        return qsl("%1/.config/mudletuna/profiles/%2/log").arg(QDir::homePath(), extra1);
    case profileLogErrorsFilePath:
        ...
        // map is loaded:
        return qsl("%1/.config/mudletuna/profiles/%2/log/errors.txt").arg(QDir::homePath(), extra1);
    case editorWidgetThemePathFile:
        ...
        if (extra1.compare(qsl("Mudlet.tmTheme"), Qt::CaseSensitive)) {
            // No match
            return qsl("%1/.config/mudletuna/edbee/Colorsublime-Themes-master/themes/%2").arg(QDir::homePath(), extra1);
        } else {
    ...
    case editorWidgetThemeJsonFile:
        ...
        return qsl("%1/.config/mudletuna/edbee/Colorsublime-Themes-master/themes.json").arg(QDir::homePath());
    case moduleBackupsPath:
        ...
        return qsl("%1/.config/mudletuna/moduleBackups/").arg(QDir::homePath());
